...
export const en: Strings = {
  ...
  settings: {
    ...
    gdriveSaveCredentials: 'Save credentials',
    ...
    gdriveSetupHintText: 'Google Cloud Console → APIs & Services → Credentials → Create OAuth 2.0 Client ID (type: Web application) → Add redirect URI: tagebuch://oauth2redirect → Enable Drive API.',
    gdriveConnectError: 'Connection failed',
    gdriveCredentialsMissing: 'Client ID and Client Secret are required.',
